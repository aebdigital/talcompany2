...
const HERO_IMAGES = [
  "https://www.talcompany.sk/sources/portfolio/HERO=EXTRA.jpg",
  "https://www.talcompany.sk/sources/portfolio/hero-2.jpg",
  "https://www.talcompany.sk/sources/portfolio/hero1.jpg",
  "https://www.talcompany.sk/sources/portfolio/photo-3.jpg",
  "https://www.talcompany.sk/sources/portfolio/photo-5.jpg"
];

const PARTNER_LOGOS = [
  { name: "BB Centrum", src: "https://www.talcompany.sk/sources/partneri-logo/bb_centrum.jpg" },
  { name: "Bilingválne gymnázium", src: "https://www.talcompany.sk/sources/partneri-logo/bilingvalne_gymnazium.jpg" },
  { name: "Billa", src: "https://www.talcompany.sk/sources/partneri-logo/billa.jpg" },
  { name: "Bytterm", src: "https://www.talcompany.sk/sources/partneri-logo/bytterm.jpg" },
  { name: "Coop Jednota", src: "https://www.talcompany.sk/sources/partneri-logo/coop_jednota.jpg" },
  { name: "DM", src: "https://www.talcompany.sk/sources/partneri-logo/dm-logo.jpg" },
  { name: "Schiedel", src: "https://www.talcompany.sk/sources/partneri-logo/schiedel.jpg" },
  { name: "Slovenské elektrárne", src: "https://www.talcompany.sk/sources/partneri-logo/slov_elektrarne.jpg" },
  { name: "SPP", src: "https://www.talcompany.sk/sources/partneri-logo/spp.jpg" },
  { name: "VÚB", src: "https://www.talcompany.sk/sources/partneri-logo/vub.jpg" },
  { name: "VÚC Žilina", src: "https://www.talcompany.sk/sources/partneri-logo/vuc_za.jpg" }
];
...
const FEATURED_PROJECTS = [
  {
    ...
    image: "https://www.talcompany.sk/sources/portfolio/30/uvn_ruzomberok_(5).jpg"
  },
  {
    id: "7",
  ...
  },
  {
    ...
    type: "od roku 2019",
    image: "https://www.talcompany.sk/sources/portfolio/29/capitis_(4).jpg"
  },
  {
    id: "17",
    title: "Budova ALPHA",
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <section className="relative h-[95vh] w-full overflow-hidden flex items-center -mt-[88px] md:-mt-[100px]">
        ...
        {/* Hero text */}
        <div className="relative z-20 max-w-[95%] mx-auto px-6 w-full mt-20">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-[95%] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          {/* Left: About Text */}
          ...
          <div className="grid grid-cols-2 gap-6 w-full lg:max-w-2xl mx-auto">
            <div className="flex flex-col gap-6">
              <div className="relative h-[250px] md:h-[280px] w-full overflow-hidden shadow-md">
                <Image
                  src="https://www.talcompany.sk/sources/portfolio/photo-1.jpg"
              ...
              <div className="relative h-[220px] md:h-[240px] w-full overflow-hidden shadow-md">
                <Image
                  src="https://www.talcompany.sk/sources/portfolio/7/zs_zazriva_001.jpg"
            ...
            <div className="relative h-[490px] md:h-[544px] w-full overflow-hidden shadow-md">
              <Image
                src="https://www.talcompany.sk/sources/portfolio/photo-3.jpg"
